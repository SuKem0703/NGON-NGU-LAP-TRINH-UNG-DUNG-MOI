...
console.log("Câu 4 - Các sản phẩm còn hàng:", inStockProducts);

// Câu 5: Kiểm tra xem có ít nhất một sản phẩm có giá trên 30.000.000 hay không
const hasExpensiveProduct = products.some(p => p.price > 30000000);
console.log("Câu 5 - Có sản phẩm nào giá trên 30tr không?", hasExpensiveProduct);
...
console.log("Câu 8 - Danh sách sản phẩm chi tiết:");
...
const sellingInStockNames = products
    ...
    .map(p => p.name);
console.log("Câu 10 - Tên các sản phẩm đang bán & còn hàng:", sellingInStockNames);